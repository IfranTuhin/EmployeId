...
class Template6 extends StatefulWidget {
  ...
  @override
  State<Template6> createState() => _Template6();
}

class _Template6 extends State<Template6> {
  @override
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: Image.asset("assets/raw/tm6_front.png").image,
                      ),
                    ),
                    child: Column(
                      children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      // color: Colors.grey,
                      image: DecorationImage(
                        image: Image.asset("assets/raw/tm6_back.png").image,
                      ),
                    ),
                    child: Column(
                      children: [
                              ...
                              ? Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      width: 15,
                                      decoration: BoxDecoration(
                                        color: const Color.fromRGBO(251, 26, 3, 1),
                                        borderRadius:
                          ...
                          children: [
                            RichText(
                              text: TextSpan(
                                text: 'Join Date     : ',
                                style: const TextStyle(
                                  color: Color.fromRGBO(251, 26, 3, 1),
                                  fontSize: 17,
                                  fontWeight: FontWeight.w500,
                                ),
                                children: <TextSpan>[
