...
class Template9 extends StatefulWidget {
  ...
  @override
  State<Template9> createState() => _Template9();
}

class _Template9 extends State<Template9> {
  @override
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: Image.asset("assets/raw/tm9_front.png").image,
                      ),
                    ),
                    child: Column(
                      children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      // color: Colors.grey,
                      image: DecorationImage(
                        image: Image.asset("assets/raw/tm9_back.png").image,
                      ),
                    ),
                    child: Column(
                      children: [
                          ...
                          child: data.userTerm1 != null ? Row(
                            ...
                            children: [
                              Container(
                                ...
                                width: 15,
                                decoration: BoxDecoration(
                                  color: const Color.fromRGBO(186, 19, 38, 1),
                                  borderRadius: BorderRadius.circular(100),
                                ),
                              ),
                              const SizedBox(
                          ...
                          children: [
                            RichText(
                              text: TextSpan(
                                text: 'Join Date     : ',
                                style: const TextStyle(
                                  color:  Color.fromRGBO(186, 19, 38, 1),
                                  fontSize: 16,
                                  fontWeight: FontWeight.w500,
                                ),
                                children: <TextSpan>[
