...
class Template25 extends StatefulWidget {
  const Template25({
    Key? key,
  }) : super(key: key);

  @override
  State<Template25> createState() => _Template25();
}

class _Template25 extends State<Template25> {
  @override
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: Image.asset("assets/raw/tm25_front.png").image,
                      ),
                    ),
                    child: Column(
                      children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      // color: Colors.grey,
                      image: DecorationImage(
                        image: Image.asset("assets/raw/tm25_back.png").image,
                      ),
                    ),
                    child: Column(
                      children: [
                          ...
                          child: data.userTerm1 != null
                            ...
                            children: [
                              Container(
                                ...
                                width: 15,
                                decoration: BoxDecoration(
                                  color: const Color.fromRGBO(240, 196, 25, 1),
                                  borderRadius: BorderRadius.circular(100),
                                ),
                              ),
                              const SizedBox(
